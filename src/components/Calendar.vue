        ...
        <v-card>
          <v-container>
            <v-form @submit.prevent="addEvent">
              ...
              <v-text-field v-model="color" type="color" label="color (click to poen color menu)"></v-text-field>
              <v-btn type="submit" color="primary" @click.stop="dialog=false">Create Event</v-btn>
            </v-form>
          </v-container>
        </v-card>
      </v-dialog>
